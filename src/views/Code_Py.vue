<template>
  <body>
    <div class="code_py">
      <h1>Code.py</h1>
      <p>This is my very first game, a text game of course its not finished (and probably wont be) but... Its working!</p>
      <p>Doing a game in python was very easy, i was i think 12 when i did it.</p>
